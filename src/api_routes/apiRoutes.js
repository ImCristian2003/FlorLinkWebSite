//////////////////////////////// RUTAS PARA EL CONSUMO DE LAS APIS

// dirección para consumir la API de ofrecimiento
export const OFRECIMIENTO_URL = "http://localhost:8081/ofrecimiento";

// dirección para consumir la API de estimados
export const ESTIMADOS_URL = "http://localhost:8082/estimado";

// dirección para consumir la API de proyección
