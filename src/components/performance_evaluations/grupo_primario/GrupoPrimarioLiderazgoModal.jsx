  ...
  const onSubmitE1ADN1 = async (e) => {
    ...
    try {
      ...
      const preguntasTexto = {
        ...
        pregunta5:
          "Promueve en su equipo la construcción de relaciones de confianza con los públicos de interés",
      };
  ...
  const onSubmitE1ADN2 = async (e) => {
    ...
    try {
      ...
      const preguntasTexto = {
        ...
        pregunta5:
          "Promueve el desarrollo y el aprendizaje continuo de su equipo",
      };
  ...
  const onSubmitE1ADN3 = async (e) => {
    ...
    try {
      ...
      const preguntasTexto = {
        ...
        pregunta5:
          "Escucha de forma receptiva y promueve la colaboración entre equipos",
        pregunta6:
          "Facilita conversaciones transparentes para resolver conflictos",
      };
  ...
  const onSubmitE1ADN4 = async (e) => {
    ...
    try {
      ...
      const preguntasTexto = {
        ...
        pregunta5:
          "Define metas retadoras para el equipo y acompaña su cumplimiento",
        pregunta6:
          "Provee recursos adecuados y hace seguimiento para asegurar resultados",
      };
      ...
      alert("Evaluación y respuestas guardadas exitosamente");
      setGrupoPrimarioLVisible(); // Cerrar modal
    } catch (err) {
      console.error(err);
      alert("Hubo un error al guardar la evaluación");
    }
          ...
          <div className="modal-content" style={{ height: "100%" }}>
            <div className="modal-header">
              <h5 className="modal-title">
                Evaluación Grupo Primario - Liderazgo
              </h5>
              <button
                type="button"
                className="btn-close"
            ...
            <div className="modal-body" style={{ overflowY: "auto" }}>
              ...
              <div className="adn-1">
                <form onSubmit={onSubmitE1ADN1}>
                  ...
                  <div style={{ marginBottom: "16px" }}>
                    <label>
                      5. Promueve en su equipo la construcción de relaciones de
                      confianza con los públicos de interés
                    </label>
                    <br />
                    {opciones.map((valor, index) => (
                      <label
              ...
              <div className="adn-2">
                <form onSubmit={onSubmitE1ADN2}>
                  ...
                  <div style={{ marginBottom: "16px" }}>
                    <label>
                      5. Promueve el desarrollo y el aprendizaje continuo de su
                      equipo
                    </label>
                    <br />
                    {opciones.map((valor, index) => (
              ...
              <div className="adn-1">
                <form onSubmit={onSubmitE1ADN3}>
                  ...
                  <div style={{ marginBottom: "16px" }}>
                    <label>
                      5. Escucha de forma receptiva y promueve la colaboración
                      entre equipos
                    </label>
                    <br />
                    {opciones.map((valor, index) => (
                  ...
                  <div style={{ marginBottom: "16px" }}>
                    <label>
                      6. Facilita conversaciones transparentes para resolver
                      conflictos
                    </label>
                    <br />
                    {opciones.map((valor, index) => (
              ...
              <div className="adn-1">
                <form onSubmit={onSubmitE1ADN4}>
                  ...
                  <div style={{ marginBottom: "16px" }}>
                    <label>
                      5. Define metas retadoras para el equipo y acompaña su
                      cumplimiento
                    </label>
                    <br />
                    {opciones.map((valor, index) => (
                  ...
                  <div style={{ marginBottom: "16px" }}>
                    <label>
                      6. Provee recursos adecuados y hace seguimiento para
                      asegurar resultados
                    </label>
                    <br />
                    {opciones.map((valor, index) => (
